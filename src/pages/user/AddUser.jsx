...
const AddUser = () => {
  ...
  const handleSelectChange = (event) => {
    ...
    setSelected(event.target.value); // Update the selected role state
  };
  return (
    <div>
      <Layout>
            ...
            <section className="">
              <form action="" className="" onSubmit={handleSubmit}>
                <div className="grid lg:grid-cols-2 xs:grid-cols-1 gap-4">
                  ...
                  <div className="">
                    <label className="mb-3 block">Fullname </label>
                    <input
                      required
                  ...
                  <div className="">
                    <label className="mb-3 block">Designation*</label>
                    <select
                      required
                      value={selected}
                      className="p-3 rounded bg-slate-300 block w-full"
