...
const AddSanitation = () => {
  ...
  <div class="mb-4 flex items-center justify-between ">
        ...
        <div key={index} class="flex items-center mr-3  ">
          <input
            ...
            value={index + 1}
                  ...
                  disabled
          />
          <label for={`livingRoomRating${index + 1}`} class="text-blue text-sm">{index + 1}</label>
        </div>
      ))}
    </div>
    ...
    <div class="mb-4 flex items-center justify-between">
      <label class="block text-blue text-2xl font-bold mr-2">Drainage</label>
      {Array.from({ length: 5 }, (_, index) => (
        <div key={index} class="flex items-center mr-2">
          <input
            ...
            value={index + 1}
                  ...
                  disabled
          />
          <label for={`drainageRating${index + 1}`} class="text-blue text-sm">{index + 1}</label>
        </div>
      ))}
                      </div>
                      ...
                      <div class="mb-4 flex items-center justify-between">
      <label class="block text-blue text-2xl font-bold mr-2">Waste Disposal</label>
      {Array.from({ length: 5 }, (_, index) => (
        <div key={index} class="flex items-center mr-2">
          <input
            type="radio"
            ...
            value={index + 1}
                  ...
                  checked={index === 2}
          />
          <label for={`wasteRating${index + 1}`} class="text-blue text-sm">{index + 1}</label>
        </div>
      ))}
    </div>
