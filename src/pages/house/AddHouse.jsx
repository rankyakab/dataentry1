...
const AddHouse = () => {
  ...
  const [selectedLGA, setSelectedLGA] = useState("Demsa");
  const [selectedSubUnit, setSelectedSubUnit] = useState("");
  const subunits = [
    "Adamawa-Demsa-ward1-93",
    "Adamawa-Demsa-ward1-10",
    "Adamawa-Demsa-ward1-39",
    "Adamawa-Demsa-ward1-45",
  ];
  const nigeriaStates = [
    "Abia",
    "Adamawa",
            ...
            <section className="">
              <form action="" className="" onSubmit={handleSubmit}>
                <div className="grid lg:grid-cols-2 xs:grid-cols-1 gap-4">
                  ...
                  <div className="">
                    <label className="mb-3 block">Sub-ward/ANGUWA *</label>
                    <select
                      required
                      className="p-3 rounded bg-slate-300 block w-full"
                    ...
                    >
                      <option value="" disabled>
                        Select Sub-ward/ANGUWA *
                      </option>
                      {subunits.map((units, index) => (
